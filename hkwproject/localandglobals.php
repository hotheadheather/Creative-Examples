...
if (date("m/d") == "06/18" || date("m/d") == "12/25"|| date("m/d") == "10/31"){
echo "Hello?";
$dayString = 1;
}
else {
...
// Following line is commented out since it generates an error since global variable $name1 is not
...
// Following line is commented out since it generates an error since local variable $name6 is not
//accessible outside a function.
